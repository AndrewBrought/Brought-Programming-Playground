...
// // *hint* the search engine search here would be "how to combine two arrays in JavaScript", for example.
    ...
    fruits.sort().concat(vegetables.sort());
...
function startsAndEndsWithVowel(character) {
    var vowels = ['a', 'e', 'i', 'o', 'u'];
    return vowels.indexOf(character[0].toLowerCase()) !== -1 &&
        vowels.indexOf(character[character.length-1].toLowerCase()) !== -1;
}
...
// Exercise 53
// Write a function definition named fourth that takes in sequence and returns the fourth value of that sequence.
function fourth(sequence){
    return sequence[3];
}

assert(fourth([1, 2, 3, 4]), 4, "Exercise 53");
assert(fourth("ubuntu"), "n", "Exercise 53");
assert(fourth(["JS", "is", "awesome", "right?"]), "right?", "Exercise 53");
...
function firstToLast(array){
    array.push(array.shift());  //We Need To Execute the Shift and Push Before Returning the Array
    return array;
...
function sumAll(array){
    return array.reduce(function(a, b){  //**NOTE The first 'return' is the generator for the sumAll function ... the second 'return' is responsible for generating the actual math inside of the handler function...
        return a + b;
    }, 0);
}
...
function mean(array){
    return sumAll(array) / array.length; // *In this function, we're using a previously defined function to handle some of the math required to generate a mean of an array
}
...
function maxMinusMin(array){
    return Math.max(...array) - Math.min(...array); //** NOTE the (...)- spread operator can span an array of numbers into the list of arguments so the math methods can be applied
}
...
// Write a function definition named onlyOddNumbers that takes in sequence of numbers and returns the odd numbers in an array.
    ...
    var odds = array.filter(number => number % 2 !== 0);
        return odds;
    }
...
// Write a function definition named onlyPositiveNumbers that takes in sequence of numbers and returns the positive numbers in an array.
   function onlyPositiveNumbers(array) {
       ...
       // return pos;
       var positives = array.filter(number => number >= 0);
       return positives;
   }
...
// Write a function definition named onlyNegativeNumbers that takes in sequence of numbers and returns the negative numbers in an array.
    function onlyNegativeNumbers(array){
        var negatives = array.filter(number => number < 0);
        return negatives;
    }
...
// Write a function definition named countEvens that takes in sequence of numbers and returns the number of even numbers
    function countEvens(array){
        var odds = array.reduce(function(a, b){
            return a + (b % 2)
        }, 0);
        var even = array.length - odds;
        return even;
    }
...
// Write a function definition named countOdds that takes in sequence of numbers and returns a count of the any odd numbers in the sequence
    function countOdds(array){
        var evens = array.reduce(function(a, b){
            return a + (b % 2 === 0);
        }, 0);
        var odds = array.length - evens;
        return odds;
    }
...
// Write a function definition named countNegatives that takes in sequence of numbers and returns a count of the number of negative numbers
   function countNegatives (array) {
       var positives = array.reduce(function (a, b) {
           return a + (b > 0);
       }, 0);
       var negatives = array.length - positives;
       return negatives;
   }
...
// Write a function definition named countPositives that takes in sequence of numbers and returns a count of the number of positive numbers
    ...
    var negatives = array.reduce(function(a, b){
        return a + (b < 0);
    },0);
    var positives = array.length - negatives;
    return positives;
    }
...
function shortestString(array) {
    ...
    // return shortest;
        ...
        var short = array.reduce(function(a, b) {
...
function longestString(array) {
    var long = array.reduce(function(a, b) {
        return a.length >= b.length ? a : b;
    });
    return long;
}
...
// Write a function definition named getUniqueValues that takes in an array and returns an with only the unique values from that array.
    ...
    var unique = array.filter((value, index, arr) => arr.indexOf(value) === index);
    return unique;
    }
...
// Write a function named totalOfBookPrices that takes in a array of objects and returns the sum total of all the book prices added together
    ...
    return books.map(price).reduce(sum);
    }
...
// Write a function named getAverageBookPrice that takes in a array of objects and returns the average book price.
    ...
    return totalOfBookPrices(books) / getNumberOfBooks(books);
...
// Hint: Much like sometimes start functions with a variable set to zero or float('inf'), you may want to create a object with the price set to float('inf') to compare to each object in the array
    ...
    let lowestPriceBook = books.reduce((a, b) =>
        a.price < b.price ? a : b
    );
...
// Hint: You may need to set an initial total price and total total quantity to zero, then sum up and divide that total price by the total quantity
    function getAverageSpentPerItem(){
        ...
        return totalPrice / totalNumberOfItems(shoppingCart);
    }
...
function mostSpentOnItem(shoppingCart){
    //     let mostItem = shoppingCart.reduce( function (first, next) {
    //         (first.items[i].price * first.shoppingCart.items[i].quantity) > (next.items[i].price * next.shoppingCart.items[i].quantity) ? first : next
    //     },0);
    // return mostItem;
    var highest = shoppingCart.items.reduce(function(a, b) {
        return (a.price * a.quantity) >= (b.price * b.quantity) ? a : b;
    });
    return highest;
}
